...
public class Loodsen_Endlessrunner extends World
{
    ...
    {    
        ...
        taskbar();
        fill();
        setPaintOrder(Afsluiten.class,Hoofdmenu.class,Taskbar2.class,HealthBar.class,Loodsboot.class,Vrachtschip.class,Kant.class, Boeien.class, Wreckage.class, Ondiepwater.class, Water.class);
    }
